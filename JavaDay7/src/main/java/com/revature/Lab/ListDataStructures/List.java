package com.revature.Lab.ListDataStructures;
...
public class List {
	...
	// Adding elements - private array should grow and shrink in size
	// automatically based on the number of elements that are part of the list. 
	...
	// Removing items - should set the last element to "null"
